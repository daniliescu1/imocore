...
class ContractChiriasData
{
    ...
    private static function normalizePj(Request $request): array
    {
        $validated = $request->validate([
            ...
            'chirias_pj.administrator.serie_ci' => ['required', 'string', 'max:10'],
            'chirias_pj.administrator.numar_ci' => ['required', 'string', 'max:20'],
            'chirias_pj.administrator.cnp' => ['required', 'string', 'max:13'],
            'chirias_pj.administrator.domiciliu' => ['required', 'string', 'max:500'],
        ...
        return [
            ...
            'chirias_date' => [
                ...
                'administrator' => [
                    ...
                    'serie_ci' => $admin['serie_ci'],
                    'numar_ci' => $admin['numar_ci'],
                    'cnp' => $admin['cnp'],
                    'domiciliu' => $admin['domiciliu'],
                    'email' => $admin['email'],
                    'email_2' => ($admin['email_2'] ?? null) ?: null,
